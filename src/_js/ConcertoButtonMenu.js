...
Concerto.ButtonMenu = function(target) {
	...
	**/
	_buildUrl = function() {
        ...
        //IE対策
        var pathname = elm.pathname.slice(0,1) === '/'?
            elm.pathname:
            '/' + elm.pathname;
        ...
        //IE対策
        if (paths.length == 0) paths.shift();
		prop.root = elm.protocol + '//' + elm.hostname + ':' + elm.port + '/' + paths[1];
	};
				...
				<ul class="menu_menu" style="position:absolute; z-index:50;">\
					...
					<li>\
						...
						<ul>\
							...
							<li><a href="' + prop.root + '/alarm_kanri2/alarm_kanri_disp.php?cd_type=11" target="_blank">当月完成後注入</a></li>\
							<li><a href="' + prop.root + '/alarm_kanri2/alarm_kanri_disp.php?cd_type=12" target="_blank">完成予定日異常</a></li>\
							<li><a href="' + prop.root + '/alarm_kanri2/alarm_kanri_disp.php?cd_type=13" target="_blank">注番未売上</a></li>\
						</ul>\
					</li>\
					<li>\
					...
					<li>\
						<a href="' + prop.root + '/kanri_data2/index.php" target="_blank">管理データ作成</a>\
						<ul>\
							<li><a href="' + prop.root + '/kanri_data2/index.php" target="_blank">管理データ作成</a></li>\
							...
							<li><a href="' + prop.root + '/gyosya_hattyu2/index.php" target="_blank">業者別発注高</a></li>\
						</ul>\
					</li>\
					<li><a href="' + prop.root + '/setubi_yoyaku2/index.php" target="_blank">設備予約</a></li>\
