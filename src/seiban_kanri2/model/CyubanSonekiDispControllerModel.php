...
class CyubanSonekiDispControllerModel extends ControllerModel
{
    ...
    */
    public function buildData($config = null)
    {
        ...
        $tanto_list = $model->getTantoList($cd_bumon_tmp);
        $input_code = $this->authUser->id;
        array_unshift(
            $tanto_list,
            [
                'cd_tanto' => "!{$input_code}",
        ...
        //error Indirect modification of overloaded property 対策
        $this->tanto_list = $tanto_list;
