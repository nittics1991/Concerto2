    ...
    */
    public function getKobanList2($kb_nendo, $cd_bumon)
    {
        ...
        */
        ...
        if (is_null($stmt)) {
            $sql = "
				SELECT D.no_cyu ,D.no_ko, D.nm_syohin2, D.dt_pkansei_m, D.dt_pkansei, D.cd_bumon 
				, D.yn_tov
				...
				FROM
					(SELECT no_cyu, no_ko, nm_syohin2, dt_pkansei_m, dt_pkansei, cd_bumon
					...
					FROM
						(SELECT no_cyu, no_ko, nm_syohin AS nm_syohin2, dt_pkansei_m, dt_pkansei, cd_bumon
							, yn_tov
					...
					GROUP BY no_cyu, no_ko, nm_syohin2, dt_pkansei_m, dt_pkansei, cd_bumon
					) D
				LEFT JOIN 
                ...
                WHERE D.dt_pkansei_m >= :yyyymm
                    AND E.dt_puriage >= :yyyymm
				ORDER BY D.dt_pkansei, E.kb_cyumon, D.no_cyu, D.no_ko 
			";
