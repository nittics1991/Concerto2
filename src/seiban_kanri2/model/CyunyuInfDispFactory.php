...
use _config\ConcertoSectionableConfig;
...
class CyunyuInfDispFactory
{
    ...
    */
    ...
    {
        $config = new ConcertoSectionableConfig(
            new ConfigReaderArray(
                realpath(__DIR__ . '/../../_config/common/seiban_kanri2/cyunyu_inf_disp.php')
            )
        );
            
        return $config->setSectionPath(
            realpath(__DIR__ . '/../../_config/common/seiban_kanri2/cyunyu_inf_disp.php')
        );
    }
