...
class CyunyuInfDispMntModel
{
    ...
    */
    public function setCyunyuData(PostCyunyuInfDisp $post)
    {
        ...
        if (count($result) != 1) {
            $yn_tanka[0] = $this->config['yn_tanka_default'] ?? 5900;
        } else {
            $obj = $result[0];
        ...
        if (count($result) != 1) {
            $yn_tanka[1] = $this->config['yn_tanka_default'] ?? 5900;
        } else {
            $obj = $result[0];
                ...
                switch ($act) {
                        ...
                        for ($i = 0; $i < count($num_data); $i++) {
                            if ($num_data[$i] != 0) {
                                ...
                                switch ($cd_genka_yoso) {
                                    case 'A':
                                        $obj->yn_cyokuzai = (int)$num_data[$i];
                                        $obj->tm_cyokka = 0.0;
                                        $obj->yn_cyokka = 0;
                                        $obj->yn_etc = 0;
                                        break;
                    ...
                    case 'update':
                        ...
                        for ($i = 0; $i < count($num_data); $i++) {
                            ...
                            switch ($cd_genka_yoso) {
                                case 'A':
                                    $data->yn_cyokuzai = (int)$num_data[$i];
                                    $data->tm_cyokka = 0.0;
                                    $data->yn_cyokka = 0;
                                    $data->yn_etc = 0;
                                    break;
